...
//Name: walk_cycle_stupid_02.ma
//Last modified: Sun, Sep 15, 2019 09:25:05 PM
//Codeset: UTF-8
...
createNode fosterParent -n "Riccoon_Rig1RNfosterParent1";
	rename -uid "3217E466-F046-654D-233B-B291733C6102";
...
createNode reference -n "Riccoon_Rig1RN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"translate" " -type \"double3\" 0.018444974866145533 0 0"
		2 "|Group|Main|MotionSystem|FKSystem|FKParentConstraintToChest_M|FKOffsetNeck_M|FKExtraNeck_M|FKNeck_M" 
		"translateX" " -av"
		2 "|Group|Main|MotionSystem|FKSystem|FKParentConstraintToChest_M|FKOffsetNeck_M|FKExtraNeck_M|FKNeck_M" 
		"translateY" " -av"
		...
		"translateZ" " -av"
		2 "|Group|Main|MotionSystem|FKSystem|FKParentConstraintToChest_M|FKOffsetNeck_M|FKExtraNeck_M|FKNeck_M" 
		"rotate" " -type \"double3\" 28.1272895389290376 -7.13599333500282018 -0.56252704036537426"
		...
		"translate" " -type \"double3\" 0.025131592031193688 0 -0.084347292753438649"
		2 "|Group|Main|MotionSystem|IKSystem|IKHandle|IKOffsetLeg_R|IKExtraLeg_R|IKLeg_R" 
		"translateX" " -av"
		2 "|Group|Main|MotionSystem|IKSystem|IKHandle|IKOffsetLeg_R|IKExtraLeg_R|IKLeg_R" 
		"translateY" " -av"
		...
		" -type \"double3\" 0.2620762873561896 0.65685534983679872 -1.41721494312129526"
		2 "|Group|Main|MotionSystem|IKSystem|IKHandle|IKSplineTailHandle_M" "rotate" 
		" -type \"double3\" 166.02359245138654842 79.64173723166669561 -3.59782310542630057"
		
		2 "|Group|Main|MotionSystem|IKSystem|IKHandle|IKSpineHandle_M" "translate" 
		" -type \"double3\" -0.088671339361260842 0.98171361739252105 0.1314138694396437"
		
		2 "|Group|Main|MotionSystem|IKSystem|IKHandle|IKSpineHandle_M" "rotate" " -type \"double3\" 80.1027820605769989 3.35142073363510384 103.54739800983723796"
		
		2 "|Group|Main|MotionSystem|IKSystem|IKHandle|IKOffsetSpine3_M|IKExtraSpine3_M|IKSpine3_M" 
		"translate" " -type \"double3\" 0.00014008358598215071 0.030104981209287871 0.00057805193569478706"
		...
		"translateZ" " -av"
		2 "|Group|Main|MotionSystem|IKSystem|IKHandle|IKOffsetSpine3_M|IKExtraSpine3_M|IKSpine3_M" 
		"rotate" " -type \"double3\" 0 0 2.67970750909119859"
		2 "|Group|Main|MotionSystem|IKSystem|IKHandle|IKOffsetSpine3_M|IKExtraSpine3_M|IKSpine3_M" 
		"rotateX" " -av"
		2 "|Group|Main|MotionSystem|IKSystem|IKHandle|IKOffsetSpine3_M|IKExtraSpine3_M|IKSpine3_M" 
		"rotateY" " -av"
		...
		"translate" " -type \"double3\" 0.087998180095665277 0.25994549730888689 0.076697677562093211"
		...
		"translate" " -type \"double3\" 0 0.035952688975020401 0"
		2 "|Group|Main|MotionSystem|RootSystem|RootCenterBtwLegsBlended_M|RootOffsetX_M|RootExtraX_M|RootX_M" 
		"translateX" " -av"
		2 "|Group|Main|MotionSystem|RootSystem|RootCenterBtwLegsBlended_M|RootOffsetX_M|RootExtraX_M|RootX_M" 
		"translateY" " -av"
		...
		"translateZ" " -av"
		2 "|Group|Main|MotionSystem|RootSystem|RootCenterBtwLegsBlended_M|RootOffsetX_M|RootExtraX_M|RootX_M" 
		"rotate" " -type \"double3\" -0.5892926104341234 -10.20363610208696414 11.8127646563972224"
...
createNode animCurveTU -n "FKNeck_M_visibility";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  0 1 1 1 22 1 26 1;
createNode animCurveTA -n "FKNeck_M_rotateX";
	...
	setAttr -s 7 ".ktv[0:6]"  0 1.3791946308724834 1 18.773831318554127
		 8 40.672899009851868 10 33.852925977042631 19 -5.3705612236435787 22 18.773831318554127
		 26 0;
createNode animCurveTA -n "FKNeck_M_rotateY";
	rename -uid "609EF1E5-834E-C8B1-FF84-C08357DD9080";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 7 ".ktv[0:6]"  0 0 1 -9.6484841165543589 8 3.0168294072650017
		 10 1.6543121817088429 19 -8.2324704103082897 22 -9.6484841165543589 26 0;
	setAttr -s 7 ".kit[2:6]"  1 18 18 18 18;
	setAttr -s 7 ".kot[2:6]"  1 18 18 18 18;
	setAttr -s 7 ".kix[2:6]"  0.99999793776093426 0.88157127694698056 
		0.89686132150013076 1 1;
	setAttr -s 7 ".kiy[2:6]"  -0.002030880074945346 -0.47205093333460335 
		-0.44231184700055154 0 0;
	setAttr -s 7 ".kox[2:6]"  0.99999793778339363 0.88157127694698056 
		0.89686132150013076 1 1;
	setAttr -s 7 ".koy[2:6]"  -0.0020308690159886815 -0.4720509333346033 
		-0.44231184700055159 0 0;
createNode animCurveTA -n "FKNeck_M_rotateZ";
	rename -uid "651B2538-114F-6412-387E-45BA411D0829";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 7 ".ktv[0:6]"  0 0 1 0.66460642978057705 8 -5.5251991622791463
		 10 2.8708549359024098 19 -4.4134367137716612 21 2.4010223516956497 26 0;
...
// End of walk_cycle_stupid_02.ma
