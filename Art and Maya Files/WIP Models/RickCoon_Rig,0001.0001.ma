...
//Name: RickCoon_Rig,0001.0001.ma
//Last modified: Sun, Sep 15, 2019 04:21:04 PM
//Codeset: UTF-8
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" -3.9902795799263373 2.3568021934792793 13.812874680778323 ;
	setAttr ".r" -type "double3" -5.1383527293883677 86.199999999986929 -1.1997764814867388e-14 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "896FC8F3-F34A-6276-B1C6-51B7072BED74";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 17.005958990560906;
...
createNode transform -s -n "front";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" -1.3764693852074927 153.21579918607438 1001.0652629496385 ;
createNode camera -s -n "frontShape" -p "front";
	rename -uid "7E75B0C5-714A-26D4-7D5D-01925622E10B";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 982.41006069801585;
	setAttr ".ow" 150.32077900062174;
...
createNode joint -n "Scapula" -p "Chest";
	...
	addAttr -ci true -sn "fatYabs" -ln "fatYabs" -at "double";
	addAttr -ci true -sn "fatZabs" -ln "fatZabs" -at "double";
	setAttr ".t" -type "double3" 0.21306430934385925 -0.08024595300080796 -2.4391971592173984 ;
	setAttr ".ro" 2;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
...
// End of RickCoon_Rig,0001.0001.ma
